...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPor = findViewById(R.id._por);
        btnEntre = findViewById(R.id._entre);
    ...
    public void onClick(View v) {
        ...
        try{
            double number1 = Double.valueOf(left.getText().toString());
            double number2 = Double.valueOf(right.getText().toString());
            ...
            else if( v.getId() == R.id._por ){
                ans.setText(String.valueOf(number1 * number2));
            }
            else if( v.getId() == R.id._entre ){
                ans.setText(String.valueOf(number1 / number2));
            }
        }
        catch (Exception e){
